      ...
      <div class="float-right nav-title">
        ...
        <div class="menus-item">
          <router-link class="menu-btn" to="/">
            <i class="iconfont iconzhuye" style="font-size: 18px"/> 首页
          </router-link>
        </div>
        ...
        <div class="menus-item">
          <router-link class="menu-btn" to="/links">
            <i class="iconfont iconlianjie" style="font-size: 18px;"/> 朋友
          </router-link>
        </div>
        <div class="menus-item">
          <router-link class="menu-btn" to="/about">
            <i class="iconfont iconzhifeiji" style="font-size: 18px"/> 关于
          </router-link>
        </div>
        <div class="menus-item">
          <router-link class="menu-btn" to="/message">
            <i class="iconfont iconpinglunzu" style="font-size: 19px"/> 留言
          </router-link>
        </div>
        <div class="menus-item">
          <a
            ...
            @click="openLogin"
          >
            <i class="iconfont icondenglu" style="font-size: 14px"/> 登录
          </a>
          <template v-else>
            <img
              class="user-avatar"
