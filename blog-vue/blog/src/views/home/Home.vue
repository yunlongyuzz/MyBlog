    ...
    <div class="home-banner" :style="cover">
      <div class="banner-container">
        ...
        <div class="blog-contact">
          <a
              class="mr-5 iconfont icon-sign_wechat"
              style="font-size: larger"
              target="_blank">
            <!-- 二维码 -->
            <div class="animated fadeInDown phoneweixin">
              <ul class="phoneweixin-all">
                <!--                <li class="phoneweixin-item">-->
                <img
                    class="phoneweixin-img"
                    src="../../../public/weixin.png"
                />
                <!--                </li>-->
              </ul>
            </div>
        ...
        <div class="blog-wrapper">
          <v-card class="animated zoomIn blog-card mt-5">
            ...
            <div class="card-info-social">
              ...
              >
                <!-- 二维码 -->
                <div class="animated fadeInDown weixin">
                  <ul class="weixin-all">
...
import "../../assets/css/weixin/iconfont.css";
...
<style lang="stylus">
@import '//at.alicdn.com/t/font_3224135_tz5wiz661i.css'
</style>

<style scoped>

.icon-sign_wechat:hover .phoneweixin {
  display: block;
}
.phoneweixin {
  display: none;
